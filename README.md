Для того, чтобы запустить эту ебалду, нужно перейти в папку, в которой лежит server.js и выполнить node server.js Если всё норм, сайт будет по адресу http://localhost:3000/
пример 
